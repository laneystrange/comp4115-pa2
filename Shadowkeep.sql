...
CREATE TABLE `matches` (
  ...
  PRIMARY KEY (`matchId`),
  KEY `tourney` (`tourney`),
  CONSTRAINT `matches_ibfk_1` FOREIGN KEY (`tourney`) REFERENCES `tournaments` (`eventName`)
...
CREATE TABLE `members` (
  ...
  CONSTRAINT `members_ibfk_1` FOREIGN KEY (`teamId`) REFERENCES `teams` (`teamId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `players` (
  ...
  `gender` enum('male','female','prefer not to answer') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
